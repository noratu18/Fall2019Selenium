...
public class WebTables {
    ...
    public void setup(){
       // driver = DriverFactory.createDriver("chrome");
        ...
        //headless mode makes executio twice faster
    ...
    public void verifyRowCount(){
        // tbody//tr --> to get all rows from table body,  excluding tabke header
        ...
        //actual result --> collection(rows.size())
    ...
    //once you find email cell in the first table that has this email
    //jdoe@hotmail.com then go to following sibling has linkText delete:
    ...
    //verify that jsmith@gmail.com doesn't exist anymore in the table
    ...
    /*
    Let's write a function that will return column index
