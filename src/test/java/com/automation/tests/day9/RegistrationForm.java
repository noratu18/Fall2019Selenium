...
public class RegistrationForm {
    ...
    public void test1(){
        ...
        driver.findElement(passwordBy).sendKeys("12344585");
        driver.findElement(phoneBy).sendKeys("234-123-4561");
        driver.findElement(femaleBy).click();
        driver.findElement(birthdayBy).sendKeys("01/12/2004");

        Select departmentSelect = new Select(driver.findElement(departmenyBy));
