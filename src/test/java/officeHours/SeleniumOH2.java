...
public class SeleniumOH2 {
    public static void main(String[] args) {
        ...
        //WebElement - is interface in selenium/java and it has many useful methods
        // .sendKeys("value that we want to send - input tag ")
        search_box.sendKeys("tshirt"+ Keys.ENTER); // it works with comm too

        /*
        <p class="alert alert-warning">
        No results were found for your search&bsp;tshirt"
        <pp>
         */
        ...
        search_box.clear();
        //.clear() -> (void) it will delete ant values from input box

        search_box.sendKeys("t-shirt" + Keys.ENTER);
        //StateElementReferenceException - element is old/stale - we want to find
